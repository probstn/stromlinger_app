...
execute_process(
  COMMAND "/usr/bin/git" show-ref "qds-4.4"
  WORKING_DIRECTORY "/home/niklas/stromlinger/build/haflinger-Release/_deps/ds-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/niklas/stromlinger/build/haflinger-Release/_deps/ds-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/niklas/stromlinger/build/haflinger-Release/_deps/ds-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
